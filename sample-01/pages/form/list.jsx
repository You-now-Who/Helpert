...
export default function Example() {
  ...
  return (
    <div className=" bg-white px-10 py-1 my-5 rounded-sm drop-shadow-lg">
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  ...
                  <input
                    ...
                    className="block flex-1 border-0 rounded-xl ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 ring-1 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6"
